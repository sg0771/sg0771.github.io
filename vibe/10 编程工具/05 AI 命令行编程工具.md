...
通过 CC Switch，你还可以在 DeepSeek、小米 MiMo 等多个国产模型之间自由切换，按需选择最合适的模型。关于用 Claude Code + DeepSeek V4 开发完整项目的实战经验，可以阅读本教程项目实战板块「AI 创意应用」分类中的《Claude Code - AI 提肛助手项目实战》。
...
如果你想看 Cursor、Claude Code、Codex 等多款主流工具的完整视频教程，并且用它们从 0 做出多个完整项目，可以看看鱼皮的[《小白都能学的 AI 编程实战》视频课](https://www.bilibili.com/cheese/play/ss475098271)，每个项目都是从需求分析到部署上线的全流程实战。
