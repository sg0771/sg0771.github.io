...
这个板块涵盖了 Vibe Coding 从入门到精通的各个方面。
...
除了主线内容，这个板块还收录了一些 AI 编程方法论的前沿文章。这些内容更适合已经有一定 AI 编程经验、想进一步提升的同学，属于选学内容。

比如 Harness Engineering（驾驭工程）教你怎么围绕 AI 搭建一整套靠谱的工作环境和流程，让 AI 持续稳定地完成大项目；Loop Engineering（循环工程）则更进一步，教你设计自动循环系统，让 AI 自主执行、自主验证、不再需要你一步步盯着。
...
如果你想获得更完整的方法论总结，鱼皮的 [《小白都能学的 AI 编程实战》视频课](https://www.bilibili.com/cheese/play/ss475098271)中配套了《AI 编程经验技巧大全》手册，系统讲解了五大核心心法、需求拆解四步法、Bug 三步排查法等实战方法论，而且在专属学员群里遇到任何问题都可以直接问我。
